...
#include "StateAnimRandomChunk.h"
#include "Util.h"
#include "Osc.h"

const char* StateAnimRandomChunk::NAME = "randomchunk";

void StateAnimRandomChunk::enter()
{
...
void StateAnimRandomChunk::update( float elapsed )
{
	timer -= elapsed;
	if ( timer < 0 && chunks > 0 )
	{
