...
const char* StateAnimSweepOnceX::NAME = "state_sweep_x";

void StateAnimSweepOnceX::enter()
{
	finished = false;
	pos = 0;
...
void StateAnimSweepOnceX::update( float elapsed )
{
	float old_pos = pos;
